class Services extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
      <section class="section section-light section-grid" id="services">
        <div class="container">
            <div class="section-tag">Our Services</div>
            <h2 class="section-title section-title-left">提供サービス</h2>
            ...
            <div class="grid grid-2">
                <div class="card featured-card">
                    <div class="card-body">
                        <h3>新規事業AIスプリント</h3>
                        <p>NEWhの100超のプロジェクト経験から得た事業構想ノウハウの生成AIとの融合。革新的なスプリントが、最短2ヶ月で解像度の高い事業構想を創出します。</p>
