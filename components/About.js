        ...
        <div class="container">
            ...
            <div class="grid grid-2">
                <div>
                    ...
                    <p>AI Innovation Nodeは、NEWhが長年培ってきた新規事業開発のノウハウとAI技術を融合させ、クライアント企業の新規事業開発プロセスを革新的に加速・進化させる専門組織です。</p>
                    <p>ビジネスストラテジスト、サービスデザイナー、プロジェクトマネージャーなど、多様な専門家が集結し、最新AI技術を駆使した新規事業開発支援サービスを提供いたします。</p>
                    <p>複雑化する事業環境においても、生成AIの活用でより早く、より広く、より深い事業構想を実現します。生成AIと人間の最適な組み合わせで、革新的なビジネスを創出します。</p>
                    <div class="mt-2">
